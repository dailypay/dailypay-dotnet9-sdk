...
<!-- UsageSnippet language="csharp" operationID="createTransfer" method="post" path="/rest/transfers" example="Instant" -->
```csharp
using DailyPay.SDK.DotNet9;
using DailyPay.SDK.DotNet9.Models.Components;
using DailyPay.SDK.DotNet9.Models.Requests;
...
<!-- UsageSnippet language="csharp" operationID="createTransfer" method="post" path="/rest/transfers" example="NextDay" -->
```csharp
using DailyPay.SDK.DotNet9;
using DailyPay.SDK.DotNet9.Models.Components;
using DailyPay.SDK.DotNet9.Models.Requests;
    ...
    TransferCreateData = new TransferCreateData() {
        Data = new TransferCreateResource() {
            Attributes = new TransferCreateAttributes() {
                ...
                Amount = 15000,
                Currency = "USD",
                Schedule = TransferCreateAttributesSchedule.NextBusinessDay,
            },
            Relationships = new TransferCreateRelationships() {
                Origin = new AccountRelationship() {
                    Data = new AccountIdentifier() {
