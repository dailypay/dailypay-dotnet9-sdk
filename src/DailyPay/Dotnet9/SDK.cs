...
namespace DailyPay.Dotnet9
{
    ...
    public class SDK: ISDK
    {
        ...
        private const string _sdkGenVersion = "2.647.2";
        ...
        public SDK(DailyPay.Dotnet9.Models.Components.Security? security = null, Func<DailyPay.Dotnet9.Models.Components.Security>? securitySource = null, long? version = null, int? serverIndex = null, ServerEnvironment? environment = null, string? serverUrl = null, Dictionary<string, string>? urlParams = null, ISpeakeasyHttpClient? client = null, RetryConfig? retryConfig = null)
        {
            if (serverIndex != null)
            {
            ...
            Func<DailyPay.Dotnet9.Models.Components.Security>? _securitySource = null;
        ...
        public class SDKBuilder
        {
            ...
            public SDKBuilder WithSecuritySource(Func<DailyPay.Dotnet9.Models.Components.Security> securitySource)
            {
                _sdkConfig.SecuritySource = securitySource;
                return this;
            }

            public SDKBuilder WithSecurity(DailyPay.Dotnet9.Models.Components.Security security)
            {
