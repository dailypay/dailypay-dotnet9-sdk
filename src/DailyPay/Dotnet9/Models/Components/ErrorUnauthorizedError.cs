...
namespace DailyPay.Dotnet9.Models.Components
{
    ...
    public class ErrorUnauthorizedError
    {
        ...
        /// </summary>
        [JsonProperty("links")]
        public ErrorUnauthorizedErrorLinks Links { get; set; } = default!;

        /// <summary>
        /// Location in the request that may have caused the error.
        /// </summary>
        [JsonProperty("source")]
        public ErrorUnauthorizedErrorSource? Source { get; set; }

        /// <summary>
        /// Additional information about the error.
        /// </summary>
        [JsonProperty("meta")]
        public ErrorUnauthorizedErrorMeta Meta { get; set; } = default!;

        /// <summary>
        /// A code that indicates what went wrong.
        /// </summary>
        [JsonProperty("code")]
        public ErrorUnauthorizedErrorCode Code { get; set; } = default!;
    }
}