...
namespace DailyPay.Dotnet9.Models.Components
{
    ...
    public class ErrorAccountCreateError
    {
        ...
        /// </summary>
        [JsonProperty("links")]
        public ErrorAccountCreateErrorLinks Links { get; set; } = default!;

        /// <summary>
        /// Location in the request that may have caused the error.
        /// </summary>
        [JsonProperty("source")]
        public ErrorAccountCreateErrorSource? Source { get; set; }

        /// <summary>
        /// Additional information about the error.
        /// </summary>
        [JsonProperty("meta")]
        public ErrorAccountCreateErrorMeta Meta { get; set; } = default!;
    }
}