...
namespace DailyPay.Dotnet9.Models.Components
{
    ...
    public class ErrorUnexpectedError
    {
        ...
        /// </summary>
        [JsonProperty("links")]
        public ErrorUnexpectedErrorLinks Links { get; set; } = default!;

        /// <summary>
        /// Location in the request that may have caused the error.
        /// </summary>
        [JsonProperty("source")]
        public ErrorUnexpectedErrorSource? Source { get; set; }

        /// <summary>
        /// Additional information about the error.
        /// </summary>
        [JsonProperty("meta")]
        public ErrorUnexpectedErrorMeta Meta { get; set; } = default!;

        /// <summary>
        /// A code that indicates what went wrong.
        /// </summary>
        [JsonProperty("code")]
        public ErrorUnexpectedErrorCode Code { get; set; } = default!;
    }
}