...
namespace DailyPay.Dotnet9.Models.Components
{
    ...
    public class ErrorNotFoundError
    {
        ...
        /// </summary>
        [JsonProperty("links")]
        public ErrorNotFoundErrorLinks Links { get; set; } = default!;

        /// <summary>
        /// Location in the request that may have caused the error.
        /// </summary>
        [JsonProperty("source")]
        public ErrorNotFoundErrorSource? Source { get; set; }

        /// <summary>
        /// Additional information about the error.
        /// </summary>
        [JsonProperty("meta")]
        public ErrorNotFoundErrorMeta Meta { get; set; } = default!;

        /// <summary>
        /// A code that indicates what went wrong.
        /// </summary>
        [JsonProperty("code")]
        public ErrorNotFoundErrorCode Code { get; set; } = default!;
    }
}