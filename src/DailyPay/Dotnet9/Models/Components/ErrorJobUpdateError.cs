...
namespace DailyPay.Dotnet9.Models.Components
{
    ...
    public class ErrorJobUpdateError
    {
        ...
        /// </summary>
        [JsonProperty("links")]
        public ErrorJobUpdateErrorLinks Links { get; set; } = default!;

        /// <summary>
        /// Location in the request that may have caused the error.
        /// </summary>
        [JsonProperty("source")]
        public ErrorJobUpdateErrorSource? Source { get; set; }

        /// <summary>
        /// Additional information about the error.
        /// </summary>
        [JsonProperty("meta")]
        public ErrorJobUpdateErrorMeta Meta { get; set; } = default!;
    }
}