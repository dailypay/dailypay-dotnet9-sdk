...
namespace DailyPay.SDK.DotNet9.Models.Components
{
    ...
    /// </remarks>
    /// </summary>
    public enum JobAttributesActivationStatus
    {
    ...
    public static class JobAttributesActivationStatusExtension
    {
        public static string Value(this JobAttributesActivationStatus value)
        {
            return ((JsonPropertyAttribute)value.GetType().GetMember(value.ToString())[0].GetCustomAttributes(typeof(JsonPropertyAttribute), false)[0]).PropertyName ?? value.ToString();
        }

        public static JobAttributesActivationStatus ToEnum(this string value)
        {
            foreach(var field in typeof(JobAttributesActivationStatus).GetFields())
            {
                ...
                if (attribute != null && attribute.PropertyName == value)
                {
                    ...
                    if (enumVal is JobAttributesActivationStatus)
                    {
                        return (JobAttributesActivationStatus)enumVal;
                    }
                }
            }

            throw new Exception($"Unknown value {value} for enum JobAttributesActivationStatus");
        }
    }
