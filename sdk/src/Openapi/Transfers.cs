...
namespace Openapi
{
    ...
    public class Transfers: ITransfers
    {
        ...
        public Transfers(ISpeakeasyHttpClient client, Func<Openapi.Models.Components.Security>? securitySource, string serverUrl, SDKConfig config)
        {
            _client = client;
        ...
        public async Task<ReadTransferResponse> ReadAsync(string transferId, long? version = 3, string? include = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "readTransfer", new List<string> { "client:admin", "client:admin" }, _securitySource);
        ...
        public async Task<ListTransfersResponse> ListAsync(long? version = 3, string? filterPersonId = null, string? include = null, string? filterBy = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "listTransfers", new List<string> { "client:admin", "client:admin" }, _securitySource);
        ...
        public async Task<CreateTransferResponse> CreateAsync(string idempotencyKey, TransferCreateData transferCreateData, long? version = 3, string? include = null)
        {
            ...
            var hookCtx = new HookContext(baseUrl, "createTransfer", new List<string> { "client:admin" }, _securitySource);
